...
import 'package:rydusuarios/pages/search_destination_page.dart';
...
class _HomePageState extends State<HomePage>
{
    ...
    await usersRef.once().then((snap)
    {
      if(snap.snapshot.value != null)
      {
        ...
        else
        {
          ...
          cMethods.displaySnackBar("estás bloqueado, comunícate con Ruta y Destino", context);
        }
      }
      else
      {
  ...
  displayUserRideDetailsContainer() async
  {
    ...
    setState(() {
      ...
      rideDetailsContainerHeight = 276;
  ...
  {
    // Limpia el conjunto de marcadores
    setState(() {
      markerSet.clear();
    });

    // Conjunto temporal de marcadores
    Set<Marker> markersTempSet = Set<Marker>();

    // Itera sobre la lista de conductores cercanos en línea
    for(OnlineNearbyDrivers eachOnlineNearbyDriver in ManageDriversMethods.nearbyOnlineDriversList)
    {
      ...
      // Crea un marcador para el conductor
      ...
      // Agrega el marcador al conjunto temporal
      markersTempSet.add(driverMarker);
    }

    // Actualiza el conjunto de marcadores del estado del widget
    setState(() {
  ...
  {
    // Inicializa la escucha de GeoFire para conductores en línea
    Geofire.initialize("onlineDrivers");
    Geofire.queryAtLocation(currentPositionOfUser!.latitude, currentPositionOfUser!.longitude, 22)!
        .listen((driverEvent)
    {
      // Verifica si hay un evento de conductor
      if(driverEvent != null)
      {
        // Obtiene el tipo de evento del conductor
        var onlineDriverChild = driverEvent["callBack"];

        // Maneja los diferentes tipos de eventos de GeoFire
        switch(onlineDriverChild)
            {
        // Cuando un nuevo conductor entra en el área de búsqueda
          case Geofire.onKeyEntered:
            ...
            // Si las claves de los conductores cercanos se cargaron, actualiza los conductores en el mapa
            if(nearbyOnlineDriversKeysLoaded == true)
            {
              // Actualiza los conductores en el mapa de Google
              updateAvailableNearbyOnlineDriversOnMap();
            }
        ...
        // Cuando un conductor se mueve dentro del área de búsqueda
        ...
        // Cuando la consulta GeoFire está lista
  ...
  updateFromDriverCurrentLocationToPickUp(driverCurrentLocationLatLng) async
  {
    if(!requestingDirectionDetailsInfo)
    {
      ...
      setState(() {
        tripStatusDisplay = "El conductor viene - ${directionDetailsPickup.durationTextString}";
      });
  ...
  updateFromDriverCurrentLocationToDropOffDestination(driverCurrentLocationLatLng) async
  {
    if(!requestingDirectionDetailsInfo)
    {
      ...
      setState(() {
        tripStatusDisplay = "Conducir hasta el lugar de entrega - ${directionDetailsPickup.durationTextString}";
      });
  ...
  noDriverAvailable()
  {
    showDialog(
        ...
        builder: (BuildContext context) => InfoDialog(
          ...
          description: "No se encontró ningún conductor en la ubicación cercana. Inténtelo de nuevo en breve.",
        )
    );
  }
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                title: const Text("Ruta y destino", style: TextStyle(color: Colors.grey),),
              ),
              ...
              GestureDetector(
                ...
                child: ListTile(
                  ...
                  title: const Text("Salir", style: TextStyle(color: Colors.grey),),
                ),
              ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ClipOval(
                          child: Image.network(
                            photoDriver == ''
                                ? "https://firebasestorage.googleapis.com/v0/b/rydusuarios.appspot.com/o/avatarman.png?alt=media&token=482cb114-a635-4eb8-b1f5-f5bd7aa1e8d6"
                                : photoDriver,
                            width: 60,
                            height: 60,
                            fit: BoxFit.cover,
                        ...
                        GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text("Llamar", style: TextStyle(color: Colors.grey,),),
